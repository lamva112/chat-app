...
import 'package:flutter_application_1/FontEnd/Preview/image_preview_screen.dart';
import 'package:flutter_application_1/Global_uses/constants.dart';
import 'package:flutter_application_1/Global_uses/enum_generation.dart';
import 'package:flutter_application_1/Global_uses/native_calling.dart';
import 'package:flutter_application_1/Global_uses/show_toast_message.dart';
                ...
                Container(
                  ...
                  child: GestureDetector(
                    onTap: () async {
                      ...
                      if (pickedVideo != null) {
                        final String thumbnailPathTake = await _nativeCallback
                            .getTheVideoThumbnail(videoPath: pickedVideo.path);
